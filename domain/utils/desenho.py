...
# def desenhar_svg_resultado_com_linha_neutra(hx, hy, num_barras_x, num_barras_y, e_x=0, e_y=0, x_arb=None, desenhar_carga=True):
#     d_linha = 5  # cm
#     margem = 30
#     escala = 5  # 1 cm = 5 px
#     largura_svg = int(hx * escala + 2 * margem)
...
#         '''
#
#     if x_arb is not None:
#         y_neutra = y0 + (hy - x_arb) * escala
#         x_ini = x0 - 10
#         x_fim = x1 + 10
#         svg += f'''
#             <line x1="{x_ini}" y1="{y_neutra}" x2="{x_fim}" y2="{y_neutra}" stroke="blue" stroke-dasharray="6,4" stroke-width="2"/>
#         '''
#
#     svg += "</svg>"
#     return svg
