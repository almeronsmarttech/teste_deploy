...
from ..forms.forms_compressao import CompressaoMadeiraForm
...
class FormularioCompressaoMadeiraView(FormView):
    form_class = CompressaoMadeiraForm
    template_name = "formulario_compressao.html"
